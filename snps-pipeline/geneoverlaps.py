...
if __name__ == "__main__":
	...
	SNPGENEPATH = OUTDIR / "snpgene.tsv"
	...
	intersections = snpgenes[snpgenes['Gene'].str.split('_').str[1].isin(genes)]

	intersections.to_csv(OUTDIR / "intersections.tsv", sep='\t', index=False)